...
```{r}
path <- "../../data"
expof <- file.path(path, "exposome_nutrition_data/exposures.csv")
descf <- file.path(path, "exposome_nutrition_data/description.csv")
phenf <- file.path(path, "exposome_nutrition_data/phenotypes.csv")
```
...
slotNames(exp_pca)
pca_loading_values <- exp_pca@pca$var$coord
```
